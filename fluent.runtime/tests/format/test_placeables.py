...
class TestPlaceables(unittest.TestCase):
    ...
    def test_placeable_bad_message(self):
        ...
        self.assertEqual(errs, [FluentReferenceError("Unknown message: not-a-message")])
    ...
    def test_placeable_bad_message_attr(self):
        ...
        self.assertEqual(len(errs), 1)
        self.assertEqual(
            errs, [FluentReferenceError("Unknown attribute: message.not-an-attr")]
        )
    ...
    def test_placeable_bad_term(self):
        ...
        self.assertEqual(len(errs), 1)
        self.assertEqual(errs, [FluentReferenceError("Unknown term: -not-a-term")])
    ...
    def test_cycle_detection(self):
        ...
        self.assertEqual(len(errs), 1)
        self.assertEqual(errs, [FluentCyclicReferenceError("Cyclic reference")])
