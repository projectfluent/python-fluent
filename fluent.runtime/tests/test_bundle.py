...
class TestFluentBundle(unittest.TestCase):
    ...
    def test_ordinal_form_english_ints(self):
        bundle = FluentBundle(["en-US"])
        self.assertEqual(bundle._ordinal_form(0), "other")
        self.assertEqual(bundle._ordinal_form(1), "one")
        self.assertEqual(bundle._ordinal_form(2), "two")
        self.assertEqual(bundle._ordinal_form(3), "few")
        self.assertEqual(bundle._ordinal_form(11), "other")
        self.assertEqual(bundle._ordinal_form(21), "one")
    ...
    def test_format_missing(self):
        self.assertRaises(LookupError, self.bundle.get_message, "a-missing-message")
